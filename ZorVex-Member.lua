...
-- URL PASTEBIN
local URL_MEMBER = "https://pastebin.com/raw/mYH9zDcH"
...
local isMember = checkWhitelist(URL_MEMBER)

if isMember then
    displayNotification("Member Detected\nScript Active", false)
    
    task.wait(2)
    
    loadstring(game:HttpGet('https://raw.githubusercontent.com/Galaxy-Rich/Huang/refs/heads/main/Script-Member-ZorVex.lua'))()
    print("Menjalankan Script Member...")
